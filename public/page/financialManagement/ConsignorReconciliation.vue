    ...
    <div class="conditional">
      <div class="conditional-box">
        ...
        <div>
          <el-button
            ...
            class="common"
            :loading="this.$store.state.config.button_loading"
            >{{ $t("BatchReconciliation") }}</el-button
          >
          <el-button
            size="small"
            @click="handleChangePageParams"
      ...
      >
        ...
        <el-table-column
          ...
          :label="$t('AmountReceivable') + '(' + currency_unit_symbol + ')'"
          width="250"
        >
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          align="center"
          prop="line_name"
          :label="$t('UncollectedAmount') + '(' + currency_unit_symbol + ')'"
          width="250"
        >
        </el-table-column>
        <el-table-column
          ...
          width="250"
          :label="$t('AmountReceived') + '(' + currency_unit_symbol + ')'"
        >
          <template slot-scope="scope">
            <span
              v-if="
    ...
    <div>
      ...
      >
        <span style="font-size: 15px">{{
          $t("ConfirmThePaymentTotalAmountPayment")
        }}</span>
