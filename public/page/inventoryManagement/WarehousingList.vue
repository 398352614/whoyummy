<template>
  ...
  <div class="inventory">
    ...
    <el-table
      ...
      :data="hasPerm('stock-in-log.index') ? tableData : []"
    ...
    >
      <template slot="empty" v-if="!hasPerm('stock-in-log.index')">
...
export default {
  ...
  methods: {
    ...
    getStock() {
      // 列表
      this.$api.getStockInLog(this.pageParams).then((res) => {
